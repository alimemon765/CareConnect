...
const GRAD = 'linear-gradient(135deg,#6C63FF,#9C88FF)';
const inputStyle = {
...
export default function AdminLogin() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (data.user.role !== 'admin') { toast.error('Not an admin account.'); setForm({ email: '', password: '' }); return; }
  ...
  return (
    <div className="min-h-dvh bg-bg px-5 pt-6 pb-10">
      ...
      <div className="flex flex-col items-center mt-4 mb-8">
        ...
        <p className="text-sm text-text-sub mt-1">Admin Portal</p>
      </div>
